...
// Суть стратегии - в зависимости от конфигурации можем меять поведение. В нашем случае конфигурации это набор данных + конфиг (набор ключ значение, в ключе название полей, в значении  - именна статических методов валидатор)